#
#  Be sure to run `pod spec lint JPVideoPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.homepage     = "http://EXAMPLE/JPVideoPlayer"
  ...
  s.source       = { :git => "https://github.com/Chris-Pan/JPVideoPlayer", :tag => "#{s.version}" }
